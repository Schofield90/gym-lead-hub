        ...
        <div className="bg-white rounded-2xl p-8 md:p-12 shadow-lg border border-gray-100 mb-16">
          <div className="grid md:grid-cols-3 gap-8 text-center">
            <div className="bg-blue-50 rounded-xl p-6">
              ...
              <h3 className="text-2xl font-bold text-gray-900 mb-2">100 FREE Leads</h3>
              <p className="text-lg text-gray-600 mb-2">Cost: £0 (Our Service)</p>
        ...
        <div className="text-center">
          <div className="bg-gradient-to-br from-green-50 to-emerald-50 border border-green-200 rounded-2xl p-8 md:p-12">
            ...
            <h3 className="text-2xl md:text-3xl font-bold text-gray-900 mb-4">
              Start Your £4,000+ Profit Journey Today
            </h3>
            <p className="text-lg text-gray-600 mb-6 max-w-3xl mx-auto">
              With our proven system, you&apos;re looking at nearly £4,000 profit from your first 100 leads alone. Our service is completely FREE until we deliver - you only cover your £1,000 ad spend.
            </p>
            ...
            >
              Claim Your £4,000+ Profit System Now
            </button>
          </div>
        </div>
      </div>
